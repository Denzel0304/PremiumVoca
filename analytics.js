...
// 보카출제 버전 — app: 'vocamakes' 표지 포함
// =============================================

(function() {
  // ── 설정 ──
  // GAS 웹앱 배포 URL (똑비서·보카암기와 동일한 URL — 같은 GAS 프로젝트)
  ...
  // localStorage에 저장할 디바이스 ID 키 (보카출제 전용으로 분리)
  const DEVICE_ID_KEY = 'vocamakes_device_id';   // ← 똑비서: 'ddog_device_id' / 보카암기: 'voca_device_id' / 보카출제: 'vocamakes_device_id'
